...
// NOTE: process.env is not available in Puter workers.
// Configure these values directly here, or load them from puter.kv at startup.
const STRIPE_SECRET_KEY = (typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.STRIPE_SECRET_KEY) || '';
const BASE_URL = (typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.BASE_URL) || 'https://roomify.app';
const FREE_RENDERS_LIMIT = parseInt((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.FREE_RENDERS_LIMIT) || '3');
const FREE_EXPORTS_LIMIT = parseInt((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.FREE_EXPORTS_LIMIT) || '5');
const FREE_PDF_EXPORTS_LIMIT = parseInt((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.FREE_PDF_EXPORTS_LIMIT) || '2');
const PREMIUM_STYLES = ((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.PREMIUM_STYLES) || 'industrial,scandinavian').split(',');
const PREMIUM_PRESETS = ((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.PREMIUM_PRESETS) || 'luxury,traditional').split(',');
const ADMIN_USER_IDS = ((typeof globalThis.__ENV__ !== 'undefined' && globalThis.__ENV__.ADMIN_USER_IDS) || 'd3f0e995-9422-43cc-8fd8-8ad83cc463c3').split(',');
