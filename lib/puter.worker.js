...
// Validate Render Limit Endpoint (for frontend to check before generation)
...
// Increment Render Count Endpoint (with validation)
...
// Increment Export Count Endpoint (with validation)
...
// Increment PDF Export Count Endpoint (with validation)
...
router.post('/api/create-checkout-session', async ({ request, user }) => {
    try {
        ...
        // Store pending subscription in KV
